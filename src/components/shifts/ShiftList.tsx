...
export default function ShiftList() {
  ...
  const handleCellClick = (row: number, col: number) => {
    ...
    setSelectedCells((prev) => {
      ...
      if (prev.length === 1) {
        ...
        // Create swap request
        createSwapRequest(fromEmployee, toEmployee, date, fromShift, toShift);
  ...
  const createSwapRequest = async (fromEmployee: string, toEmployee: string, date: string, fromShift: string, toShift: string) => {
